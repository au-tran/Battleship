 ...
 * <h1>Cruiser class</h1>
 * <p>
 * Cruiser is a type of ship that inherited from Ship class
 * 
 * @author Au, Phu, Tri
 * @version 1.0
 * @since 11-29-2018
...
public class Cruiser extends Ship{
	...
	/**
	 * This method initalizes and sets the properties of Cruiser
	 * @param Nothing
	 * @return Nothing
	 */
	public Cruiser()
	{
		super.setLength(3);
		super.setHealth(3);
		super.setShipName("Cruiser");
		super.setSunken(false);
	}
	
	/**
	 * This method prints the string representation of Cruiser
	 * @param Nothing
