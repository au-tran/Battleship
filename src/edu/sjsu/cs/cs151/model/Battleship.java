...
/**
 * <h1>Battleship class</h1>
 * <p>
 * Battleship is a type of ship that inherited from Ship class
 * 
 * @author Au, Phu, Tri
 * @version 1.0
 * @since 11-29-2018
...
public class Battleship extends Ship{
	...
	/**
	 * This method initalizes and sets the properties of battleship
	 * @param Nothing
	 * @return Nothing
	 */
	public Battleship()
	{
		super.setLength(4);
		super.setHealth(4);
		super.setShipName("Battleship");
		super.setSunken(false);
	}

	/**
	 * This method prints the string representation of battleship
	 * @param Nothing
	 * @return a String of info of battleship
	 */
